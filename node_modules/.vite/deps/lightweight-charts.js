...
var DevicePixelContentBoxBinding = function() {
	function DevicePixelContentBoxBinding$1(canvasElement, transformBitmapSize, options) {
		...
		this._transformBitmapSize = transformBitmapSize !== null && transformBitmapSize !== void 0 ? transformBitmapSize : (function(size$2) {
			return size$2;
		});
...
var CanvasRenderingTarget2D = function() {
	...
	CanvasRenderingTarget2D$1.prototype.useMediaCoordinateSpace = function(f) {
		try {
			this._context.save();
	...
	CanvasRenderingTarget2D$1.prototype.useBitmapCoordinateSpace = function(f) {
		try {
			this._context.save();
			this._context.setTransform(1, 0, 0, 1, 0, 0);
			return f({
...
(function(LineType$1) {
	...
	* A line.
	*/
	LineType$1[LineType$1["Simple"] = 0] = "Simple";
	/**
	* A stepped line.
	*/
	LineType$1[LineType$1["WithSteps"] = 1] = "WithSteps";
	/**
	* A curved line.
	*/
	LineType$1[LineType$1["Curved"] = 2] = "Curved";
})(LineType || (LineType = {}));
/**
* Represents the possible line styles.
*/
var LineStyle;
(function(LineStyle$1) {
	/**
	* A solid line.
	*/
	LineStyle$1[LineStyle$1["Solid"] = 0] = "Solid";
	/**
	* A dotted line.
	*/
	LineStyle$1[LineStyle$1["Dotted"] = 1] = "Dotted";
	/**
	* A dashed line.
	*/
	LineStyle$1[LineStyle$1["Dashed"] = 2] = "Dashed";
	/**
	* A dashed line with bigger dashes.
	*/
	LineStyle$1[LineStyle$1["LargeDashed"] = 3] = "LargeDashed";
	/**
	* A dotted line with more space between dots.
	*/
	LineStyle$1[LineStyle$1["SparseDotted"] = 4] = "SparseDotted";
})(LineStyle || (LineStyle = {}));
	...
	_internal__drawImpl({ context: ctx, horizontalPixelRatio, verticalPixelRatio }) {
		...
		const draw = (radiusMedia) => {
			...
			for (let i = visibleRange.to - 1; i >= visibleRange.from; --i) {
				...
				const radius$2 = radiusMedia * verticalPixelRatio + correction;
...
*/
var CrosshairMode;
(function(CrosshairMode$1) {
	/**
	* This mode allows crosshair to move freely on the chart.
	*/
	CrosshairMode$1[CrosshairMode$1["Normal"] = 0] = "Normal";
	/**
	* This mode sticks crosshair's horizontal line to the price value of a single-value series or to the close price of OHLC-based series.
	*/
	CrosshairMode$1[CrosshairMode$1["Magnet"] = 1] = "Magnet";
	/**
	* This mode disables rendering of the crosshair.
	*/
	CrosshairMode$1[CrosshairMode$1["Hidden"] = 2] = "Hidden";
	/**
	...
	*/
	CrosshairMode$1[CrosshairMode$1["MagnetOHLC"] = 3] = "MagnetOHLC";
...
var TextWidthCache = class {
	...
	_internal_measureText(ctx, text, optimizationReplacementRe$1) {
		return this._private__getMetrics(ctx, text, optimizationReplacementRe$1).width;
	}
	_internal_yMidCorrection(ctx, text, optimizationReplacementRe$1) {
		const metrics = this._private__getMetrics(ctx, text, optimizationReplacementRe$1);
		return ((metrics.actualBoundingBoxAscent || 0) - (metrics.actualBoundingBoxDescent || 0)) / 2;
	}
	_private__getMetrics(ctx, text, optimizationReplacementRe$1) {
		const re = optimizationReplacementRe$1 || defaultReplacementRe;
...
(function(MismatchDirection$1) {
	/**
	* Search the nearest left item
	*/
	MismatchDirection$1[MismatchDirection$1["NearestLeft"] = -1] = "NearestLeft";
	/**
	* Do not search
	*/
	MismatchDirection$1[MismatchDirection$1["None"] = 0] = "None";
	/**
	* Search the nearest right item
	*/
	MismatchDirection$1[MismatchDirection$1["NearestRight"] = 1] = "NearestRight";
...
function mergeMinMax(first, second) {
	if (first === null) return second;
		...
		const min$1 = Math.min(first._internal_min, second._internal_min);
...
var PanePrimitiveWrapper$1 = class PanePrimitiveWrapper$2 extends PrimitiveWrapper {
...
var Series = class extends PriceDataSource {
	constructor(model, seriesType, options, createPaneView$7, customPaneView) {
		super(model);
		...
		this._private__paneView = createPaneView$7(this, this._internal_model(), customPaneView);
	}
	_internal_destroy() {
	...
	_internal_markerDataAtIndex(index) {
		...
		if (bar === null) return null;
		const price = bar._internal_value[3];
		const radius$2 = this._private__markerRadius();
...
*/
var PriceScaleMode;
(function(PriceScaleMode$1) {
	/**
	* Price scale shows prices. Price range changes linearly.
	*/
	PriceScaleMode$1[PriceScaleMode$1["Normal"] = 0] = "Normal";
	/**
	* Price scale shows prices. Price range changes logarithmically.
	*/
	PriceScaleMode$1[PriceScaleMode$1["Logarithmic"] = 1] = "Logarithmic";
	/**
	* Price scale shows percentage values according the first visible value of the price scale.
	* The first visible value is 0% in this mode.
	*/
	PriceScaleMode$1[PriceScaleMode$1["Percentage"] = 2] = "Percentage";
	/**
	* The same as percentage mode, but the first value is moved to 100.
	*/
	PriceScaleMode$1[PriceScaleMode$1["IndexedTo100"] = 3] = "IndexedTo100";
...
var PriceScale = class {
	...
	_internal_pointsArrayToCoordinates(points, baseValue, visibleRange) {
		...
		for (let i = fromIndex; i < toIndex; i++) {
			...
			const invCoordinate = bh + hmm * (logical - min$1);
...
function findBestPrimitiveHitTest(sources, x, y) {
	...
	for (const source of sources) {
		...
		for (const hitResult of primitiveHitResults) if (comparePrimitiveZOrder(hitResult.zOrder, bestPrimitiveHit?.zOrder)) {
...
var FormattedLabelsCache = class {
	constructor(format, horzScaleBehavior, size$2 = 50) {
		this._private__actualSize = 0;
		this._private__usageTick = 1;
		this._private__oldestTick = 1;
		this._private__cache = /* @__PURE__ */ new Map();
...
var TimeScale = class {
	...
	_internal_setBarSpacing(newBarSpacing) {
		...
		if (this._private__options.rightOffsetPixels !== void 0 && oldBarSpacing !== 0) this._private__rightOffset = this._private__rightOffset * oldBarSpacing / this._private__barSpacing;
		this._private__correctOffset();
		this._private__model._internal_recalculateAllPanes();
		this._private__model._internal_lightUpdate();
	}
...
(function(TrackingModeExitMode$1) {
	/**
	* Tracking Mode will be deactivated on touch end event.
	*/
	TrackingModeExitMode$1[TrackingModeExitMode$1["OnTouchEnd"] = 0] = "OnTouchEnd";
	/**
	* Tracking Mode will be deactivated on the next tap event.
	*/
	TrackingModeExitMode$1[TrackingModeExitMode$1["OnNextTap"] = 1] = "OnNextTap";
...
var ChartModel = class {
	...
	_internal_setHoveredSource(source) {
		if (this._private__hoveredSource?._internal_source === source?._internal_source && this._private__hoveredSource?._internal_object?._internal_externalId === source?._internal_object?._internal_externalId) return;
	...
	*/
	...
	_internal_moveSeriesToPane(series, newPaneIndex) {
		...
		if (newPaneIndex === fromPaneIndex) return;
		...
		if (previousPane._internal_dataSources().length === 0) this._private__cleanupIfPaneIsEmpty(previousPane);
		this._internal_fullUpdate();
	}
	...
	_private__cleanupIfPaneIsEmpty(pane) {
		if (!pane._internal_preserveEmptyPane() && pane._internal_dataSources().length === 0 && this._private__panes.length > 1) this._private__panes.splice(this._internal_getPaneIndex(pane), 1);
	}
};
...
(function(LastPriceAnimationMode$1) {
	/**
	* Animation is always disabled
	*/
	LastPriceAnimationMode$1[LastPriceAnimationMode$1["Disabled"] = 0] = "Disabled";
	/**
	* Animation is always enabled.
	*/
	LastPriceAnimationMode$1[LastPriceAnimationMode$1["Continuous"] = 1] = "Continuous";
	/**
	* Animation is active after new data.
	*/
	LastPriceAnimationMode$1[LastPriceAnimationMode$1["OnDataUpdate"] = 2] = "OnDataUpdate";
...
function precisionByMinMove(minMove) {
	...
	for (; i < 8; i++) {
		...
		if (Math.abs(intPart - minMove) < 1e-8) return i;
		minMove = minMove * 10;
	}
	return i;
}
...
*/
var PriceLineSource;
(function(PriceLineSource$1) {
	/**
	* Use the last bar data.
	*/
	PriceLineSource$1[PriceLineSource$1["LastBar"] = 0] = "LastBar";
	/**
	* Use the last visible data of the chart viewport.
	*/
	PriceLineSource$1[PriceLineSource$1["LastVisible"] = 1] = "LastVisible";
})(PriceLineSource || (PriceLineSource = {}));
/**
* Represents a type of color.
*/
var ColorType;
(function(ColorType$1) {
	/** Solid color */
	ColorType$1["Solid"] = "solid";
	/** Vertical gradient color */
	ColorType$1["VerticalGradient"] = "gradient";
})(ColorType || (ColorType = {}));
/**
...
*/
var TickMarkType;
(function(TickMarkType$1) {
	/**
	* The start of the year (e.g. it's the first tick mark in a year).
	*/
	TickMarkType$1[TickMarkType$1["Year"] = 0] = "Year";
	/**
	* The start of the month (e.g. it's the first tick mark in a month).
	*/
	TickMarkType$1[TickMarkType$1["Month"] = 1] = "Month";
	/**
	* A day of the month.
	*/
	TickMarkType$1[TickMarkType$1["DayOfMonth"] = 2] = "DayOfMonth";
	/**
	* A time without seconds.
	*/
	TickMarkType$1[TickMarkType$1["Time"] = 3] = "Time";
	/**
	* A time with seconds.
	*/
	TickMarkType$1[TickMarkType$1["TimeWithSeconds"] = 4] = "TimeWithSeconds";
...
function createBoundCanvas(parentElement, size$2) {
	...
	binding.resizeCanvasElement(size$2);
	return binding;
}
...
var PriceAxisWidget = class {
	constructor(pane, options, rendererOptionsProvider, side) {
		...
		this._private__cell.style.position = "relative";
		this._private__canvasBinding = createBoundCanvas(this._private__cell, size({
			width: 16,
			height: 16
		}));
		...
		canvas.style.left = "0";
		canvas.style.top = "0";
		this._private__topCanvasBinding = createBoundCanvas(this._private__cell, size({
			width: 16,
			height: 16
		}));
...
var PaneWidget = class PaneWidget {
	constructor(chart, state) {
		...
		this._private__canvasBinding = createBoundCanvas(paneWrapper, size({
			width: 16,
			height: 16
		}));
		this._private__canvasBinding.subscribeSuggestedBitmapSizeChanged(this._private__canvasSuggestedBitmapSizeChangedHandler);
		...
		canvas.style.left = "0";
		canvas.style.top = "0";
		this._private__topCanvasBinding = createBoundCanvas(paneWrapper, size({
			width: 16,
			height: 16
		}));
		this._private__topCanvasBinding.subscribeSuggestedBitmapSizeChanged(this._private__topCanvasSuggestedBitmapSizeChangedHandler);
	...
	_internal_setPriceAxisSize(width, position) {
		...
		ensureNotNull(priceAxisWidget)._internal_setSize(size({
			width,
...
var TimeAxisWidget = class {
	constructor(chartWidget, horzScaleBehavior) {
		...
		this._private__canvasBinding = createBoundCanvas(this._private__dv, size({
			width: 16,
			height: 16
		}));
		this._private__canvasBinding.subscribeSuggestedBitmapSizeChanged(this._private__canvasSuggestedBitmapSizeChangedHandler);
		...
		canvas.style.left = "0";
		canvas.style.top = "0";
		this._private__topCanvasBinding = createBoundCanvas(this._private__dv, size({
			width: 16,
			height: 16
		}));
		this._private__topCanvasBinding.subscribeSuggestedBitmapSizeChanged(this._private__topCanvasSuggestedBitmapSizeChangedHandler);
	...
	_internal_setSizes(timeAxisSize, leftStubWidth, rightStubWidth) {
		...
		if (this._private__leftStub !== null) this._private__leftStub._internal_setSize(size({
			width: leftStubWidth,
			height: timeAxisSize.height
		}));
		if (this._private__rightStub !== null) this._private__rightStub._internal_setSize(size({
...
var ChartWidget = class {
	...
	_internal_resize(width, height, forceRepaint = false) {
		...
		const sizeHint = suggestChartSize(size({
			width,
			height
		}));
	...
	*/
	...
	_private__adjustSizeImpl() {
		...
		for (let paneIndex = 0; paneIndex < this._private__paneWidgets.length; ++paneIndex) {
			...
			paneWidget._internal_setSize(size({
				width: paneWidth,
				height: paneHeight
			}));
	...
	_private__setMouseWheelEventListener(add$1) {
		if (add$1) {
...
var TimeScaleApi = class {
	...
	_private__onSizeChanged(size$2) {
		this._private__sizeChanged._internal_fire(size$2.width, size$2.height);
	}
};
...
var ChartApi = class {
	...
	paneSize(paneIndex = 0) {
		const size$2 = this._private__chartWidget._internal_paneSize(paneIndex);
		return {
	...
	_private__addSeriesImpl(definition, options = {}, paneIndex = 0) {
		...
		const createPaneView$7 = definition._internal_createPaneView;
		const series = new Series(this._private__chartWidget._internal_model(), definition.type, strictOptions, createPaneView$7, definition._internal_customPaneView);
...
function drawSeriesPointMarkers(renderingScope, items, pointMarkersRadius, visibleRange, styleGetter) {
	...
	let prevStyle = null;
	const correction = Math.max(1, Math.floor(horizontalPixelRatio)) % 2 / 2;
	const radius$2 = pointMarkersRadius * verticalPixelRatio + correction;
	for (let i = visibleRange.to - 1; i >= visibleRange.from; --i) {
		const point = items[i];
		if (point) {
...
function walkLine(renderingScope, items, lineType, visibleRange, barWidth, styleGetter, finishStyledArea$2) {
	...
	if (visibleRange.to - visibleRange.from < 2) {
		...
		finishStyledArea$2(renderingScope, currentStyle, item1, item2);
	} else {
		const changeStyle = (newStyle, currentItem$1) => {
			finishStyledArea$2(renderingScope, currentStyle, currentStyleFirstItem, currentItem$1);
			ctx.beginPath();
			currentStyle = newStyle;
			currentStyleFirstItem = currentItem$1;
		};
		...
		if (currentStyleFirstItem !== currentItem || currentStyleFirstItem === currentItem && lineType === 1) finishStyledArea$2(renderingScope, currentStyle, currentStyleFirstItem, currentItem);
	}
}
var curveTension = 6;
...
var PaneRendererLineBase = class extends BitmapCoordinatesPaneRenderer {
	...
	_internal__drawImpl(renderingScope) {
		...
		if (lineType !== void 0) walkLine(renderingScope, items, lineType, visibleRange, barWidth, styleGetter, finishStyledArea$1);
...
function createYieldCurveChart(container, options) {
	const htmlElement = fetchHtmlElement(container);
	return new YieldChartApi(htmlElement, options);
}
...
var ImageWatermarkRenderer = class {
	...
	_private__determinePlacement(data, paneSize) {
		...
		const x = plotCentreX - .5 * drawWidth;
		const y = plotCentreY - .5 * drawHeight;
		return {
			_internal_x: x,
			_internal_y: y,
...
function shapeSize(shape, originalSize) {
	switch (shape) {
		case "arrowDown":
		case "arrowUp": return size$1(originalSize, 1);
		case "circle": return size$1(originalSize, .8);
		case "square": return size$1(originalSize, .7);
	}
}
...
function shapeMargin(barSpacing) {
	return Math.max(size$1(barSpacing, .1), 3);
}
...
function drawArrow(up, ctx, coords, size$2) {
	const halfArrowSize = (shapeSize("arrowUp", size$2) - 1) / 2 * coords._internal_pixelRatio;
	const halfBaseSize = (ceiledOdd(size$2 / 2) - 1) / 2 * coords._internal_pixelRatio;
	ctx.beginPath();
	if (up) {
...
function hitTestArrow(up, centerX, centerY, size$2, x, y) {
	const halfArrowSize = (shapeSize("arrowUp", size$2) - 1) / 2;
	const halfBaseSize = (ceiledOdd(size$2 / 2) - 1) / 2;
...
function drawCircle(ctx, coords, size$2) {
	const halfSize = (shapeSize("circle", size$2) - 1) / 2;
	ctx.beginPath();
	ctx.arc(coords._internal_x, coords._internal_y, halfSize * coords._internal_pixelRatio, 0, 2 * Math.PI, false);
	ctx.fill();
}
function hitTestCircle(centerX, centerY, size$2, x, y) {
	const tolerance = 2 + shapeSize("circle", size$2) / 2;
	const xOffset = centerX - x;
	const yOffset = centerY - y;
	return Math.sqrt(xOffset * xOffset + yOffset * yOffset) <= tolerance;
}
function drawSquare(ctx, coords, size$2) {
	const squareSize = shapeSize("square", size$2);
...
function hitTestSquare(centerX, centerY, size$2, x, y) {
	const squareSize = shapeSize("square", size$2);
...
function fillSizeAndY(rendererItem, marker, seriesData, offsets, textHeight, shapeMargin$1, series, chart) {
	...
	const shapeSize$1 = calculateShapeHeight(timeScale.options().barSpacing) * sizeMultiplier;
	const halfSize = shapeSize$1 / 2;
	rendererItem._internal_size = shapeSize$1;
	switch (marker.position) {
		case "inBar":
		case "atPriceMiddle":
			rendererItem._internal_y = ensureNotNull(series.priceToCoordinate(price));
			if (rendererItem._internal_text !== void 0) rendererItem._internal_text._internal_y = rendererItem._internal_y + halfSize + shapeMargin$1 + textHeight * .6;
			return;
		case "aboveBar":
		case "atPriceTop": {
			...
			if (!ignoreOffset) offsets._internal_aboveBar += shapeSize$1 + shapeMargin$1;
			return;
		}
		case "belowBar":
		case "atPriceBottom": {
			...
			rendererItem._internal_y = ensureNotNull(series.priceToCoordinate(price)) + halfSize + offset;
			if (rendererItem._internal_text !== void 0) {
				rendererItem._internal_text._internal_y = rendererItem._internal_y + halfSize + shapeMargin$1 + textHeight * .6;
				offsets._internal_belowBar += textHeight * 1.2;
			}
			if (!ignoreOffset) offsets._internal_belowBar += shapeSize$1 + shapeMargin$1;
			return;
		}
	}
}
